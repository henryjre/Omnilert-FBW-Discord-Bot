...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    } else if (interaction.message.interaction.commandName === 'request authorization') {
    ...
    const buttonRow = new ActionRowBuilder().addComponents(confirmButton, rejectButton);
    ...
    const interimButtonRow = new ActionRowBuilder().addComponents(confirmInterim, rejectInterim);
    ...
    if (messageEmbed.data.description.includes('INTERIM DUTY FORM')) {
