...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const vnrIssuanceChannel = await client.channels.cache.get(
      vnrIssuanceChannelId
    );
    ...
    await client.commands
      .get("edit_vnr_status")
      .execute(messageEmbed, "📝 Issued", vnrThreadMessage.url, client);

    const replyEmbed = new EmbedBuilder()
      .setDescription(
        `✅ Please proceed to <#${vnrIssuanceChannelId}> to issue the VN.`
      )
      .setColor("Green");
